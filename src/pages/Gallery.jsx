      ...
      <AnimatePresence>
        {trails.map(t => (
          <motion.div key={t.id}
            ...
            style={{ position:"fixed", left: t.x-55, top: t.y-70, width:170, height:140, borderRadius:10, overflow:"hidden", border:"2px solid rgba(168,85,247,0.6)", boxShadow:"0 4px 20px rgba(168,85,247,0.4)" }}>
...
const TIMELINE = [
  ...
  desc:  "Uniforms, new faces, and countless introductions. From not knowing each other to standing together as a group, this was where everything began. The first classes, first friendships, and the first steps into the world of ECE.",
  quote: '"We came as strangers, but this was the day we unknowingly found our people."',
  photo: "/videos/mem1.jpeg",
  side:  "left",
  color: "#a855f7",
  emoji: "🌱",
},
  {
  year:  "2023",
  title: "Moments That Bonded Us 🍽️💬",
  desc:  "Between classes and assignments, these small breaks became our favorite memories. Sharing food, laughter, and endless conversations, we slowly turned from classmates into a close-knit group that made every day lighter and happier.",
  quote: '"It was never just about the food — it was about the moments we shared together."',
  photo: "/videos/mem10.jpeg",
  side:  "right",
  color: "#ec4899",
  emoji: "🍽️",
},
  ...
  desc:  "Beyond classrooms and circuits, we stepped into the community through NSS activities. From teamwork to leadership, we learned that engineering is not just about technology — it’s about responsibility, impact, and working together for a better society.",
  quote: '"ECE taught us to build systems, but NSS taught us to build humanity."',
  photo: "/videos/nss.jpeg",
  side:  "left",
  color: "#3b82f6",
  emoji: "🤝",
},
  ...
  desc:  "From circuits to concepts, we turned ideas into impact. Participating in hackathons and paper presentations, we showcased our skills in communication systems, embedded tech, and real-world problem solving.",
  quote: '"We didn’t just learn ECE — we applied it, presented it, and proved it."',
  photo: "/videos/mem6.jpeg",
  side:  "right",
  color: "#f59e0b",
  emoji: "🏆",
},
  {
    year:  "2026",
    title: "End of An Era 💖",
    desc:  "The last lecture. The last canteen chai. The last time all 48 of us were in the same room. It is the end of something beautiful — and the beginning of everything we were prepared for.",
    quote: '"Not goodbye. Just see you on the other side."',
    photo: "/videos/mem7.jpeg",
    side:  "left",
    color: "#10b981",
    emoji: "💖",
  },
...
function PolaroidCard({ item, inView }) {
  ...
  return (
    ...
    >
      {/* photo */}
      <div style={{ width:"100%", aspectRatio:"5/3", overflow:"hidden", borderRadius:3, background:"#111" }}>
  ...
  return (
    <div style={{ background:"#03010a", minHeight:"100vh", color:"white", cursor:"none" }}>
      ...
      <motion.div
        ...
        <p style={{ marginTop:16, fontSize:11, color:"rgba(255,255,255,0.25)", letterSpacing:"0.3em" }}>— ECE – B Batch, 2022–2026</p>
      </motion.div>
